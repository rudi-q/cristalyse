          ...
          home: Scaffold(
            body: CristalyseChart()
                ...
                .interaction(
                  tooltip: TooltipConfig(
                    builder: (point) =>
                        Text('Fast tooltip: ${point.getDisplayValue('y')}'),
            ...
            body: CristalyseChart()
                ...
                .interaction(
                  tooltip: TooltipConfig(
                    builder: (point) {
                      final revenue =
                          double.tryParse(point.getDisplayValue('revenue')) ??
                          0;
                      final target =
                          double.tryParse(point.getDisplayValue('target')) ?? 0;
                      final performance = target > 0
                          ? (revenue / target * 100).toStringAsFixed(1)
                          : 'N/A';
                      final status = revenue >= target
                          ? '✅ On Track'
                          : '⚠️ Below Target';

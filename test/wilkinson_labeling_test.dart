...
void main() {
  ...
  group('Wilkinson Labeling', () {
    ...
    test(
      'Website visitors: [1855.2, 7420.6] should give nice round numbers',
      () {
        final ticks = WilkinsonLabeling.extended(
          1855.2,
          7420.6,
        ...
        for (final tick in ticks) {
          expect(
            tick % 1000,
            0,
            reason: 'Tick $tick should be multiple of 1000',
          );
        }
    ...
    test(
      'Very small range: [0.12, 0.18] should produce appropriate decimals',
      () {
        final ticks = WilkinsonLabeling.extended(
          0.12,
          0.18,
    ...
    test(
      'Reversed range: [100, 0] should swap and produce ascending ticks',
      () {
        final ticks = WilkinsonLabeling.extended(
          100,
          0,

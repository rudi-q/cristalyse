...
class SvgExportPainter {
  ...
  void _renderGeometries(
    ...
    for (final geometry in chartData.geometries) {
      if (geometry.toString().contains('Point')) {
        _renderPointGeometry(buffer, plotArea, chartData, xScale, yScale, colorScale, sizeScale);
      } else if (geometry.toString().contains('Line')) {
        _renderLineGeometry(buffer, plotArea, chartData, xScale, yScale, colorScale);
      } else if (geometry.toString().contains('Bar')) {
        _renderBarGeometry(buffer, plotArea, chartData, xScale, yScale, colorScale);
      }
    }
  }

  void _renderPointGeometry(StringBuffer buffer, _Rect plotArea, _ChartData chartData, _Scale xScale, _Scale yScale, Map<String, String> colorScale, Map<String, double> sizeScale) {
  ...
  void _renderLineGeometry(StringBuffer buffer, _Rect plotArea, _ChartData chartData, _Scale xScale, _Scale yScale, Map<String, String> colorScale) {
  ...
  void _renderBarGeometry(StringBuffer buffer, _Rect plotArea, _ChartData chartData, _Scale xScale, _Scale yScale, Map<String, String> colorScale) {
...
// Helper classes (duplicated for web - in a real implementation, these would be shared)
class _ChartData {

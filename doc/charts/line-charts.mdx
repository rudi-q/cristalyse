...
seo:
  title: 'Flutter Line Charts - Time Series & Trend Analysis | Cristalyse'
  description: 'Build smooth, animated line charts in Flutter with Cristalyse. Multi-series support, progressive drawing, and customizable styles for time series data visualization.'
  keywords: 'flutter line chart, time series flutter, trend analysis chart, multi-series line chart, animated line chart flutter, cristalyse line'
  canonical: 'https://docs.cristalyse.com/charts/line-charts'
---

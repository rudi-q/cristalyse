...
seo:
  title: 'Quick Start - Create Flutter Charts in 30 Seconds | Cristalyse'
  description: 'Learn how to create beautiful Flutter charts with Cristalyse in just 30 seconds. Step-by-step tutorial for building scatter plots using grammar of graphics.'
  keywords: 'flutter chart tutorial, cristalyse quickstart, grammar of graphics flutter, flutter scatter plot, flutter data visualization tutorial, flutter charts guide'
  canonical: 'https://docs.cristalyse.com/quickstart'
---
